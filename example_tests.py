...
def example_tests():
    ...
    #Test 1: testing gradient of logistic by comparing them to finite differences approximations
    ...
    # Test 4: testing gradient of ridge by comparing them to finite differences approximations
    ...
    # Test 5: testing gradient of hinge by comparing them to finite differences approximations
    # we will test hinge using checkgrad on randomly generated x and y data
    # initializing w randomly in [0,1) and lambda with 1e-05. The gradient is supposed
